							...
							int nNumBlockX, int nNumBlockZ, float fBlockSizeX, float fBlockSizeZ)
{
	...
	for (int z = 0; z < (g_nNumBlockZField + 1); z++)
	{
		for (int x = 0; x < (g_nNumBlockXField + 1); x++)
		{
			...
			g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.y = 0;
			...
			else
			{
				if (x % (int)g_PointX == 0)
				{
					g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.y = (float)(rand() % (int)g_High) - g_High / 2;
				}
				//else if (z % (int)g_PointZ == 0)
				//{
				//	g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.y = (float)(rand() % (int)g_High) - g_High / 2;
				//}
				else if (x % (int)g_PointX == 1)
				{
					g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.y = g_Vertex[z * (g_nNumBlockXField + 1) + (x - 1)].Position.y + (float)(rand() % ((int)g_High / 2) - g_High / 4);
				}
				//else if (z % (int)g_PointZ == 1)
				//{
				//	g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.y = (g_Vertex[(z - 1) * (g_nNumBlockXField + 1) + x].Position.y + g_Vertex[(z + 1) * (g_nNumBlockXField + 1) + x].Position.y) / 2;
				//}
				else if (x % (int)g_PointX == 2)
				{
					g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.y = g_Vertex[z * (g_nNumBlockXField + 1) + (x - 1)].Position.y + (float)(rand() % ((int)g_High / 2) - g_High / 4);
				}
				//else if (z % (int)g_PointZ == 2)
				//{
				//	g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.y = (g_Vertex[(z - 2) * (g_nNumBlockXField + 1) + x].Position.y + g_Vertex[(z + 2) * (g_nNumBlockXField + 1) + x].Position.y) / 2;
				//}
				else if (x % (int)g_PointX == 3)
				{
					g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.y = g_Vertex[z * (g_nNumBlockXField + 1) + (x - 1)].Position.y + (float)(rand() % ((int)g_High / 2) - g_High / 4);
				}
				//else if (z % (int)g_PointZ == 3)
				//{
				//	g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.y = (g_Vertex[(z - 1) * (g_nNumBlockXField + 1) + x].Position.y + g_Vertex[(z + 1) * (g_nNumBlockXField + 1) + x].Position.y) / 2;
				//}
			}
